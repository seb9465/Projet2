...
describe("Gestionnaire de collisions", () => {
    ...
    beforeEach( () => {
        ...
        cls = new GestionnaireCollision(voitureJoueur, voitureAI);
    ...
    it("Vérification de la formule vitesse", () => {
        const voitures: Voiture[] = cls["voitures"];
        ...
        const formuleFonction: Function = cls["calculeNouvelleVitesse"];
